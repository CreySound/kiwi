...
print("LOADED V1.3 I14") --fuck v2 fucker
...
local Window =
    Rayfield:CreateWindow(
    {
        ...
        KeySettings = {
            ...
            Key = {"🔑 uᴉ ʞɔol"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
        }
    }
)
